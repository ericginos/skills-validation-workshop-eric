...
DEFAULT_DATASET = os.environ.get("BIGQUERY_DATASET", os.environ.get("DEFAULT_DATASET", "customer_service"))
DEFAULT_TABLE = os.environ.get("BIGQUERY_TABLE", os.environ.get("DEFAULT_TABLE", "transcripts"))
MAX_RETRIES = 3
...
def get_default_project_id() -> str:
    ...
    return (
        ...
        or "qwiklabs-gcp-04-c9826cb9816d"
    )
